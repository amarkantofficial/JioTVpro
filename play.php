<html>
<head>
<title><?php echo $_REQUEST["c"]; ?> | ThopTVPro</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge"/>
<link rel="shortcut icon" type="image/x-icon" href="https://siasky.net/IACs2CNSZ-cdGAJSxVe9PoArcbIhH4CDJhmeLej6qRLEGw">
...
.loading {
    ...
    .plyr__video-wrapper::after {
        ...
        height: 35px;
        width: 35px;
        background: url('https://siasky.net/IACs2CNSZ-cdGAJSxVe9PoArcbIhH4CDJhmeLej6qRLEGw') no-repeat;
        background-size: 35px auto, auto;
    }
...
<div class="loading-text">
    ...
    <span class="loading-text-words">R</span>
     <span class="loading-text-words">O</span>
     <br>
       <span class="loading-text-words">DownloadApp:-https://tinyurl.com/ThopTVPro</span>
</div>
</div>
